...
const Biblioteca = {
    ...
    oncreate: () => {
        document.title = "Biblioteca de Credenciales | " + App.title;
        _Main();
    },
    view: () => {
        return [
            ...
            m('iframe', {
                width: "100%",
                height: "600rem",
                src: "https://appdocumentosdirmed.azurewebsites.net/DM/Login/Auth2Factor/" + localStorage.appUser + "/" + localStorage.accessToken
            }),
        ];
    },
